...
export declare const DEFINITION_TYPE_INTEGER = "integer";
export declare const DEFINITION_TYPE_BOOLEAN = "boolean";
export declare const DEFINITION_TYPE_OBJECT = "object";
export declare const DEFINITION_TYPE_ARRAY = "array";
